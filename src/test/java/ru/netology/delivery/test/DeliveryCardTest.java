...
public class DeliveryCardTest {
    ...
    void shouldSuccessfulPlanMeeting() {
        ...
        var firstMeetingDate = DataGenerator.generateData(daysAddForFirstMeeting);
        var daysToAddForSecondMeeting = 7;
        var secondMeetingDate = DataGenerator.generateData(daysToAddForSecondMeeting);
